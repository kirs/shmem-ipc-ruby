...
pub unsafe extern "C" fn Init_shmem_ipc() {
    ...
    rb_define_singleton_method(FLOAT_SENDER_CLASS, b"new\0".as_ptr() as *const i8, Some(float_sender_new as unsafe extern "C" fn() -> VALUE), 1);
    rb_define_singleton_method(FLOAT_SENDER_CLASS, b"open\0".as_ptr() as *const i8, Some(float_sender_open as unsafe extern "C" fn() -> VALUE), 4);
    rb_define_method(FLOAT_SENDER_CLASS, b"get_fds\0".as_ptr() as *const i8, Some(float_sender_get_fds as unsafe extern "C" fn() -> VALUE), 0);
    rb_define_method(FLOAT_SENDER_CLASS, b"send_data\0".as_ptr() as *const i8, Some(float_sender_send_data as unsafe extern "C" fn() -> VALUE), 1);
    ...
    rb_define_singleton_method(FLOAT_RECEIVER_CLASS, b"new\0".as_ptr() as *const i8, Some(float_receiver_new as unsafe extern "C" fn() -> VALUE), 1);
    rb_define_singleton_method(FLOAT_RECEIVER_CLASS, b"open\0".as_ptr() as *const i8, Some(float_receiver_open as unsafe extern "C" fn() -> VALUE), 4);
    rb_define_method(FLOAT_RECEIVER_CLASS, b"get_fds\0".as_ptr() as *const i8, Some(float_receiver_get_fds as unsafe extern "C" fn() -> VALUE), 0);
    rb_define_method(FLOAT_RECEIVER_CLASS, b"receive_data\0".as_ptr() as *const i8, Some(float_receiver_receive_data as unsafe extern "C" fn() -> VALUE), 0);
    ...
    rb_define_singleton_method(INTEGER_SENDER_CLASS, b"new\0".as_ptr() as *const i8, Some(integer_sender_new as unsafe extern "C" fn() -> VALUE), 1);
    rb_define_singleton_method(INTEGER_SENDER_CLASS, b"open\0".as_ptr() as *const i8, Some(integer_sender_open as unsafe extern "C" fn() -> VALUE), 4);
    rb_define_method(INTEGER_SENDER_CLASS, b"get_fds\0".as_ptr() as *const i8, Some(integer_sender_get_fds as unsafe extern "C" fn() -> VALUE), 0);
    rb_define_method(INTEGER_SENDER_CLASS, b"send_data\0".as_ptr() as *const i8, Some(integer_sender_send_data as unsafe extern "C" fn() -> VALUE), 1);
    ...
    rb_define_singleton_method(INTEGER_RECEIVER_CLASS, b"new\0".as_ptr() as *const i8, Some(integer_receiver_new as unsafe extern "C" fn() -> VALUE), 1);
    rb_define_singleton_method(INTEGER_RECEIVER_CLASS, b"open\0".as_ptr() as *const i8, Some(integer_receiver_open as unsafe extern "C" fn() -> VALUE), 4);
    rb_define_method(INTEGER_RECEIVER_CLASS, b"get_fds\0".as_ptr() as *const i8, Some(integer_receiver_get_fds as unsafe extern "C" fn() -> VALUE), 0);
    rb_define_method(INTEGER_RECEIVER_CLASS, b"receive_data\0".as_ptr() as *const i8, Some(integer_receiver_receive_data as unsafe extern "C" fn() -> VALUE), 0);
    ...
    rb_define_singleton_method(BYTE_SENDER_CLASS, b"new\0".as_ptr() as *const i8, Some(byte_sender_new as unsafe extern "C" fn() -> VALUE), 1);
    rb_define_singleton_method(BYTE_SENDER_CLASS, b"open\0".as_ptr() as *const i8, Some(byte_sender_open as unsafe extern "C" fn() -> VALUE), 4);
    rb_define_method(BYTE_SENDER_CLASS, b"get_fds\0".as_ptr() as *const i8, Some(byte_sender_get_fds as unsafe extern "C" fn() -> VALUE), 0);
    rb_define_method(BYTE_SENDER_CLASS, b"send_data\0".as_ptr() as *const i8, Some(byte_sender_send_data as unsafe extern "C" fn() -> VALUE), 1);
    ...
    rb_define_singleton_method(BYTE_RECEIVER_CLASS, b"new\0".as_ptr() as *const i8, Some(byte_receiver_new as unsafe extern "C" fn() -> VALUE), 1);
    rb_define_singleton_method(BYTE_RECEIVER_CLASS, b"open\0".as_ptr() as *const i8, Some(byte_receiver_open as unsafe extern "C" fn() -> VALUE), 4);
    rb_define_method(BYTE_RECEIVER_CLASS, b"get_fds\0".as_ptr() as *const i8, Some(byte_receiver_get_fds as unsafe extern "C" fn() -> VALUE), 0);
    rb_define_method(BYTE_RECEIVER_CLASS, b"receive_data\0".as_ptr() as *const i8, Some(byte_receiver_receive_data as unsafe extern "C" fn() -> VALUE), 0);
}